...
if __name__ == '__main__':
    ...
    train_sample_cnt = [500, 1000, 2000, 5000, 10000, 20000, 60000]
    for sample_cnt in train_sample_cnt:

        print("{} samples".format(sample_cnt))

        # 载入训练集和测试集的数据
        train_images = np.load('train_images.npy')[:sample_cnt]
        train_labels = np.load('train_labels.npy')[:sample_cnt]
